...
|:--------------------------------------------------------|:---------------------------|:--------|:--------------------------------|:--------|
| Oil demand for non-heating end uses                     | oil_non_heat_eh            | MW      | ['energy_hub', 'seasonal_week'] | float   |
| Solid fuel demand for boiler heating                    | building_solidfuel_boiler  | MW      | ['energy_hub', 'seasonal_week'] | float   |
| Solid fuel demand for non-heating end uses              | solid_fuel_non_heat_eh     | MW      | ['energy_hub', 'seasonal_week'] | float   |
| Electricity demand                                      | elecload                   | MW      | ['energy_hub', 'seasonal_week'] | float   |
| Gas demand                                              | gasload                    | mcm     | ['gas_nodes', 'seasonal_week']  | float   |
| Residential gas demand for non-heating end uses         | gasload_non_heat_res       | mcm     | ['energy_hub', 'seasonal_week'] | float   |
| Residential electricity demand for non-heating end uses | elecload_non_heat_res      | MW      | ['energy_hub', 'seasonal_week'] | float   |
| Commercial gas demand for non-heating end uses          | gasload_non_heat_com       | mcm     | ['energy_hub', 'seasonal_week'] | float   |
| Commercial electricity demand for non-heating end uses  | elecload_non_heat_com      | MW      | ['energy_hub', 'seasonal_week'] | float   |
| Hydrogen demand for non-heating end uses                | hydrogen_non_heat_eh       | MW      | ['energy_hub', 'seasonal_week'] | float   |
| Biomass demand for boiler heating                       | building_biomass_boiler    | MW      | ['energy_hub', 'seasonal_week'] | float   |
| Electricity demand for boiler heating                   | building_elec_boiler       | MW      | ['energy_hub', 'seasonal_week'] | float   |
| Electricity demand for heat pumps                       | building_heatpump          | MW      | ['energy_hub', 'seasonal_week'] | float   |
| Gas demand for boiler heating                           | building_gas_boiler        | mcm     | ['energy_hub', 'seasonal_week'] | float   |
| Hydrogen demand for boiler heating                      | building_hydrogen_boiler   | MW      | ['energy_hub', 'seasonal_week'] | float   |
| Hydrogen demand for heat pumps                          | building_hydrogen_heatpump | MW      | ['energy_hub', 'seasonal_week'] | float   |
| Oil demand for boiler heating                           | building_oil_boiler        | MW      | ['energy_hub', 'seasonal_week'] | float   |
| District heating biomass demand                         | dh_biomass_boiler          | MW      | ['energy_hub', 'seasonal_week'] | float   |
| District heating electricity demand                     | dh_elec_boiler             | MW      | ['energy_hub', 'seasonal_week'] | float   |
| District heating gas demand                             | dh_gas_CHP                 | mcm     | ['energy_hub', 'seasonal_week'] | float   |
| District heating hydrogen demand                        | dh_hydrogen_fuelcell       | MW      | ['energy_hub', 'seasonal_week'] | float   |
| Transport electricity demand                            | elec_trans                 | MWh     | ['energy_hub', 'seasonal_week'] | float   |
| Transport hydrogen demand                               | hydrogen_trans             | MWh     | ['energy_hub', 'seasonal_week'] | float   |
