...
def main():
	...
	# get the base directry and build the path for the database config files
	...
	auto_hydrate_db = input("Populate database with available data? ")
	if auto_hydrate_db.lower() == 'y' or auto_hydrate_db.lower() == 'yes':
		...
		print("Input incorectly entered - you entered: %s. The database will not be setup or populated. Exiting setup." %auto_hydrate_db)
		exit()
