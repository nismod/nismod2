...
if __name__ == '__main__':
    INPUT_FILENAME = '../data/transport/southampton/data/csvfiles/railStationGeneralisedJourneyTimes.csv'
    OUTPUT_FILENAME = '../data/scenarios/rail_station_generalised_journey_times.csv'
