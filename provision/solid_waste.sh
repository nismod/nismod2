...
# pass nismod base directory as first argument
base_path=$1

# Run db migrations
su vagrant -c "python $base_path/models/solid_waste/db/run_migrations.py -d"
su vagrant -c "python $base_path/models/solid_waste/db/run_migrations.py -u"
