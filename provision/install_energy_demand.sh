...
path_strategy_vars = /vagrant/data/energy_demand/00_user_defined_variables
#ONS principal projection
path_population_data_for_disaggregation_LAD = /vagrant/data/energy_demand/_raw_data/J-population_disagg_by/uk_pop_principal_2015_2050.csv
#ONS principal projection
folder_raw_carbon_trust = /vagrant/data/energy_demand/_raw_data/G_Carbon_Trust_advanced_metering_trial/
path_population_data_for_disaggregation_MSOA = /vagrant/data/energy_demand/_raw_data/J-population_disagg_by/uk_pop_principal_2015_2050_MSOA_lad.csv
folder_path_weater_stations = /vagrant/data/energy_demand/_raw_data/A-temperature_data/cleaned_weather_stations.csv
path_floor_area_virtual_stock_by = /vagrant/data/energy_demand/_raw_data/K-floor_area/floor_area_LAD_latest.csv
...
lad_shapefile = /vagrant/data/energy_demand/_raw_data/C_LAD_geography/same_as_pop_scenario/lad_2016_uk_simplified.shp
